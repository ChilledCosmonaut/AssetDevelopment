...
const signTexLoader = new TextureLoader().setPath('Assets/textures/signs/');
...
function create(environment = null, title = "Exhibit Title", text = "Description of usage.", modelname = 'defaultSign', font = "Arial"){
    ...
    this.loadSign = function(position = new Vector3(0,0,0), rotation = new Vector3(0,0,0), scale = new Vector3(1,1,1)){
        //Create text texture 
        ...
        //applying texture
        var textTexture = new CanvasTexture(drawingCanvas);

        //create
        var sign = new Object3D();
        ...
        var signMaterial = new MeshStandardMaterial({
            map: textTexture,
            metalness: 0,
            roughness: 1
        ...
        var signBorderMaterial = new MeshStandardMaterial({
        ...
        loader.load( 'Assets/models/signs/'+this.modelname+'.fbx', function ( object ) {
